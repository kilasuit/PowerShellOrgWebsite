...
This was a fascinating thing to see throughout The Scripting Games this year:Â _When exactly should you use Write-Verbose, and why?Â _The same question applies to Write-Debug.
...
"I use Write-Debug to provide developer-level comments in my scripts, since I can turn it on with -Debug to see variable contents."
  ...
  * "I use Write-VerboseÂ to provide developer-level comments in my scripts, since I can turn it on with -Debug to see variable contents."
...
What guidance wouldÂ _you_ offer for using Write-Verbose and Write-Debug in a script?  
