...
RefreshMode                    : PUSH
PSComputerName                 :
`This is where we can configure the behavior of DSC for a particular node. Â So, how do we configure it? Â With DSC of course!  
There is a configuration option LocalConfigurationManager that allows us to set values for the Local Configuration Manager. Â A sample configuration looks something like this:
