...
In just 2Â½ weeks from now, the [2012 Microsoft Management Summit][5] (MMS) will start, and it"™s going to be an amazing conference this year.  With the upcoming [Microsoft System Center 2012][6] release, and with [Windows 8 currently available as a Consumer Preview][7] in the client and the server varieties (both of which include the pre-release version of PowerShell version 3), there are plenty of new opportunities to scale up your PowerShell prowess and scale out your scripting capabilities while learning how to get the most of these new products and platforms by leveraging PowerShell automation.
