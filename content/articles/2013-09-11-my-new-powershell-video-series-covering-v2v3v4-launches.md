...
Best of all, you can watch the whole thing for under $100. CBT Nuggets' program gives you monthly access to their entire library for that price, including my entire PowerShell series, their hundreds of titles related to certification and technology,Â _everything.Â _Or pay $1000 for an entire year - which also gets you access to practice certification exams from Transcender.  
I'll be publishing 5-10 videos per week in this series, until it's done - and we'll then be tackling domain-specific PowerShell management, including Exchange, AD, SQL Server, System Center,Â _all_ of it. It'll take some time to build out all of that, but I'm committed to building the most comprehensive PowerShell video training offering in the universe!  
