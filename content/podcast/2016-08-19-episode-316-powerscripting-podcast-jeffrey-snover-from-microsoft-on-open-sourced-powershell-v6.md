...
aliases:
  - /2016/08/episode-316-powerscripting-podcast-jeffrey-snover-from-microsoft-on-open-sourced-powershell-v6/
---
...
**Chatroom Highlights**  
 ...
 ok, if you have qââ‚¬â„¢s, then as sqlvariant has shown, please add ## to the front!
 ...
 ## How can I get paid to work on open source powershell? 😛
...
<<@UNJM7|jonwalz>> jonwalz uploaded a file: Pasted image at 2016-08-18, 8:51 PM 
[
https://powershell.slack.com/files/jonwalz/F22RNF6UQ/pasted_image_at_2016_08_18_08_51_pm.png 
](https://powershell.slack.com/files/jonwalz/F22RNF6UQ/pasted_image_at_2016_08_18_08_51_pm.png)
and commented: Anyone else seeing PowerShell as the top trending topic on Facebook?



[
https://github.com/PowerShell/PowerShell/blob/master/docs/community/governance.md
][1]  


[
https://github.com/PowerShell/PowerShell/tree/master/src/Microsoft.Management.Infrastructure.CimCmdlets
][2]  
...
[
https://www.facebook.com/topic/Windows-Powershell/109314949087498?source=whfrt&position=2&trqid=6320345599904818250
][3]  

 @foxde 
[
https://github.com/PowerShell/PowerShell/blob/master/docs/installation/windows.md#msi
][4]  

<<@UPLLB|halr9000>> halr9000 uploaded a file: Untitled 
[
https://powershell.slack.com/files/halr9000/F22S025RC/-.pl
][5]  


[
https://www.reddit.com/r/PowerShell/comments/4yb5yb/who_is_the_mystery_guest_tonight_and_what_might/d6mgixw
][6]  
...
https://developer.microsoft.com/en-us/windows/iot/getstarted
 ...
 I liked this thread in hacker news: 
[
https://news.ycombinator.com/item?id=12314653
][9] 
- nice demonstration of why, even if you *can* use text, you might prefer objects
...
[ 
https://gist.github.com/Jaykul/15a6982aad9b6197a537f1ce5a786723
][11]  
...
[
https://github.com/PowerShell/PowerShell/issues/929#issuecomment-239697927
][14]  


 ARM!!! 
[
https://media.giphy.com/media/HJN39I1q6EBKE/giphy.gif
](https://media.giphy.com/media/HJN39I1q6EBKE/giphy.gif)  

 @itadder the hard part is that other than ASP.NET 
[
http://ASP.NET
][15] 
Core there is no presentation stack for .NET Core.  VSCode gets a pass because it uses Electron / Chromium / Html / JS
...
[
https://github.com/dfinke/PowerShellSlackathon/tree/master/ExportDataTable
][19]  
...
http://redhatloves.net/
 ...
 also 
[
https://github.com/Pash-Project/Pash/issues/429
][21]  

 Is .ps a TLD?  RedHat should get RedHatLoves.ps 
[
http://RedHatLoves.ps
][22]  
...
[
https://github.com/PowerShell/PowerShell/issues/1103
][24]  


[
https://github.com/PowerShell/PowerShell/issues/1390
][25]  
...
<<@URXAA|dereksonthejob>> dereksonthejob uploaded a file: Screen Shot 2016-08-18 at 10.41.10 PM 
[
https://powershell.slack.com/files/dereksonthejob/F22SKJQLR/screen_shot_2016-08-18_at_10.41.10_pm.png
](https://powershell.slack.com/files/dereksonthejob/F22SKJQLR/screen_shot_2016-08-18_at_10.41.10_pm.png) 
and commented: here we go
...
<<@URXAA|dereksonthejob>> dereksonthejob uploaded a file: @r_keith_hill 
[
https://powershell.slack.com/files/dereksonthejob/F22SRLC02/screen_shot_2016-08-18_at_10.41.10_pm.png
](https://powershell.slack.com/files/dereksonthejob/F22SRLC02/screen_shot_2016-08-18_at_10.41.10_pm.png) 
and commented: I have it now, thx to @itadder


 https://github.com/PowerShell/PowerShell/issues/1621


 https://github.com/PowerShell/PowerShell/issues/706


 https://github.com/PowerShell/PowerShell/issues/1273
...
<<@UNNCY|r_keith_hill>> r_keith_hill uploaded a file: RE line endings: 
[
https://powershell.slack.com/files/r_keith_hill/F22SHCYDB/pasted_image_at_2016_08_18_08_54_pm.png 
](https://powershell.slack.com/files/r_keith_hill/F22SHCYDB/pasted_image_at_2016_08_18_08_54_pm.png)
and commented: Just a LF but concerns me the default encoding is unicode for out-file still


 [1]: https://github.com/PowerShell/PowerShell/blob/master/docs/community/governance.md
 [2]: https://github.com/PowerShell/PowerShell/tree/master/src/Microsoft.Management.Infrastructure.CimCmdlets
 [3]: https://www.facebook.com/topic/Windows-Powershell/109314949087498?source=whfrt&position=2&trqid=6320345599904818250
 [4]: https://github.com/PowerShell/PowerShell/blob/master/docs/installation/windows.md#msi
 [5]: https://powershell.slack.com/files/halr9000/F22S025RC/-.pl
 [6]: https://www.reddit.com/r/PowerShell/comments/4yb5yb/who_is_the_mystery_guest_tonight_and_what_might/d6mgixw
 [7]: https://stedolan.github.io/jq/
 [8]: https://developer.microsoft.com/en-us/windows/iot/getstarted
 [9]: https://news.ycombinator.com/item?id=12314653
 [10]: https://linux.slashdot.org/story/15/06/30/0058243/interviews-linus-torvalds-answers-your-question
 [11]: https://gist.github.com/Jaykul/15a6982aad9b6197a537f1ce5a786723
 [12]: https://github.com/PowerShell/PowerShell/issues/929
 [13]: https://github.com/PowerShell/PowerShell/pull/1901
 [14]: https://github.com/PowerShell/PowerShell/issues/929#issuecomment-239697927
 [15]: http://ASP.NET
 [16]: http://electron.atom.io/apps/
 [17]: https://github.com/kexplo/electron-edge
 [18]: https://youtu.be/2WZwv7TxqZ0
 [19]: https://github.com/dfinke/PowerShellSlackathon/tree/master/ExportDataTable
 [20]: http://redhatloves.net/
 [21]: https://github.com/Pash-Project/Pash/issues/429
 [22]: http://RedHatLoves.ps
 [23]: https://www.gitbook.com/
 [24]: https://github.com/PowerShell/PowerShell/issues/1103
 [25]: https://github.com/PowerShell/PowerShell/issues/1390
 [26]: https://cloud.google.com/tools/powershell/docs/
 [27]: http://prnt.sc/c7jmuo
 [28]: http://apisof.net/catalog/System
 [29]: http://sqlps.io/dl
 [30]: https://youtu.be/rc6lwiTE9GI
 [31]: http://unix.stackexchange.com/questions/695/where-does-mac-os-x-come-from
