...
aliases:
  - /2012/12/up-next-eli-white-makes-mayhem/
---

Tonight on the podcast, we are talking about MAYHEM! No, it's not a car insurance commercial, and no, it's not anything dangerous. Mayhem is a sort of automation engine for Windows that (among very many other things), has the ability to invoke PowerShell scripts when something happens. Join us live [in the chatroom][1] tonight at 9:30 PM EST!  
Here's the blurb from the [Mayhem website][2]:

> [
mayhem
](http://mayhem.codeplex.com/releases/view/82086#DownloadId=340745)
There are a lot of great applications out there. But what do you do when you need to do something, but there isn&rsquo;t an app for that? Mayhem is an application that lets you connect trigger events to reactions. Unlike writing a program, you simply select an event and a reaction, and then turn on the connection. Voila! No code or app required.
