...
aliases:
  - /2009/10/and-were-on-twitter-too/
---
...
Here are the ways you can follow us on Twitter:
  ...
  * Jonathan: [twitter.com/jonwalz][1]
  * Hal: [twitter.com/halr9000][2]
  * (new) The Show: [twitter.com/powerscripting][3]
...
This last one will automatically post when Jon posts the show, so this will be a fast way to find out when that happens.
 ...
 [3]: http://twitter.com/powerscripting
