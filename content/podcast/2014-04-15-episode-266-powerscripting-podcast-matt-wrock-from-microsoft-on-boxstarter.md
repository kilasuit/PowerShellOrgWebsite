...
podcast_url: "http://traffic.libsyn.com/powerscripting/PSPodcast-266.mp3"
aliases:
  - /2014/04/episode-266-powerscripting-podcast-matt-wrock-from-microsoft-on-boxstarter/
---

**A Podcast about Windows PowerShell.** Listen:


  **[![](http://powerscripting.libsyn.com/img/podcastIcon.gif)](http://traffic.libsyn.com/powerscripting/PSPodcast-266.mp3)**
...
#### 
  ...
  [22:43:30]  FWIW, my 2c: I think a "moderated" feed (where you just trust the core chocolatey team to review packages, instead of trusting all the authors) is the answer to "trust" -- the idea being the core team says that yes, this module just downloads and installs "the real product" that it claims to.
   ...
   if you use LastPass check out this tool [http://blog.lastpass.com/2014/04/lastpass-now-checks-if-your-sites-are.html](http://blog.lastpass.com/2014/04/lastpass-now-checks-if-your-sites-are.html)


   [http://www.atlantaallergy.com/pollenCount.aspx](http://www.atlantaallergy.com/pollenCount.aspx)


   [http://www.nwasthma.com/pollen/pollen-count](http://www.nwasthma.com/pollen/pollen-count)


   [http://boxstarter.org/](http://boxstarter.org/)


   [http://runasradio.com/?nomobile=1&ShowNum=355](http://runasradio.com/?nomobile=1&ShowNum=355)
   ...
   Downloading SublimeText3 64 bit ([http://c758482.r82.cf2.rackcdn.com/Sublime%20Text%20Build%203059%20x64%20Setup.exe](http://c758482.r82.cf2.rackcdn.com/Sublime%20Text%20Build%203059%20x64%20Setup.exe)


   [http://www.myget.org/](http://www.myget.org/)


   halr9000: [http://c758482.r82.cf2.rackcdn.com/Sublime%20Text%202.0.2%20x64%20Setup.exe](http://c758482.r82.cf2.rackcdn.com/Sublime%20Text%202.0.2%20x64%20Setup.exe) <-- that's the "official" download link.


   [http://inedo.com/proget/overview](http://inedo.com/proget/overview)


   Sorry, yeah, [http://c758482.r82.cf2.rackcdn.com/Sublime%20Text%20Build%203059%20x64%20Setup.exe](http://c758482.r82.cf2.rackcdn.com/Sublime%20Text%20Build%203059%20x64%20Setup.exe) my point is that your url was the official one


   [http://boxstarter.org/WebLauncher](http://boxstarter.org/WebLauncher)


   [http://www.boxstarter.org/VMIntegration](http://www.boxstarter.org/VMIntegration)


   e.g. [http://boxstarter.org/package/nr/firefox](http://boxstarter.org/package/nr/firefox)


   [http://boxstarter.org/package/nr/rickroll](http://boxstarter.org/package/nr/rickroll)


   [http://boxstarter.org/WebLauncher](http://boxstarter.org/WebLauncher) has links to the firefox and chrome click once extensions at the end of the page


   [http://boxstarter.org/package/astley](http://boxstarter.org/package/astley)
