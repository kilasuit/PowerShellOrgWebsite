...
aliases:
  - /2013/05/powershell-birds-of-a-feather-sessions-at-ms-teched/
---
...
We don't have room or catalog numbers yet, but we will update this post when those details are available.
 Post updated! The first session will be a 100-300 level discussion. The second session will stay in the100-200 level. Funny thing about BOFs though is that the discussion is driven by who is in the room, not the moderator, so all we can say for sure is that PowerShell will be discussed. 🙂
