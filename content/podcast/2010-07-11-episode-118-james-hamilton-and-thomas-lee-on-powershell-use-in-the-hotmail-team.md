...
_ 
  ...
  * Sapien [announces][1]{#rax9}Â Visual PowerShell 2011. [Q&A][2]{#c9jv}
  * Tweet from @jaykul: Save 37% on @[
Manning
](http://twitter.com/Manning)Â Books (including eBooks). Get your WindowsÂ [
#PowerShell
](http://twitter.com/search?q=%23PowerShell)Â in Action or PowerShell in Practice ...
[http://bit.ly/97qQ3D](http://bit.ly/97qQ3D)
  ...
  * Listener @sqlVariant just had his talk accepted to the SQL PASS summit! Title is:Â [The Dirty Dozen: PowerShell Scripts for the Busy DBA][6]
...
[SQLSaturday #49](http://www.sqlsaturday.com/49/eventhome.aspx)Â will be held Oct 16, 2010 at Seminole State College. They are actively seeking PowerShell papers, [submit yours today](http://www.sqlsaturday.com/49/callforspeakers.aspx)! Due date 7/16.
...
Questions:
  ...
  * SQLvariant: ## Does the Hotmail team go beyond using PowerShell to just script? Â Do they make interfaces that have PowerShell underneath like SCVMM?
  ...
  * SQLvariant: @bj11 ##can you speak to any chalenges in working with large amounts of XML with PowerShell. Â Do you run the scripts to gather from your desktops or a big server?
  ...
  * glnsize: ## given your scale what's your opinion on v2 remoting. Â have you used it and how has it performed for you... Â (arrived late sorry if already covered)
  ...
  * Toshana: ## Are you using the readily available cmdlets, or custom written cmdlets or imported .net assembliesÂ 
...
This segment is brought to you by [SAPIEN Technologies][13]{#hbu4}.
  ...
  * [@beefarino][15]{#vy65}Â posted his "[PowerShell as a Tools Platform][16]{#w.7e}" slide deck fromÂ [Codestock 2010][17]{#izqc}.
  * [Inspecting Deleted AD Objects before Restore][18]{#yp4e}
  * Ed Wilson spoke to the Tampa PowerShell User Group today (7/8) about best practices and you can access the Live Meeting recordingÂ [here][19].
  * 
[cspshell](http://twitter.com/cspshell):
Â 21 User Information Commands to Run Before You DieÂ 
...
** 
 ...
 [10]: http://queue.acm.org/detail.cfm?id=1113332 "A CONVERSATION WITH PHIL SMOOT -Â THE CHALLENGES OF MANAGING A MEGASERVICE"
