...
### In This Episode
  ...
  * We have a great show lined up for you today.Â  Don Jones from Sapien is here.Â  [applause]Â  He'll be giving us a taste of the trade show circuit, going into CTP2, and other goings-on in the PowerShell world.Â  And of course we have tips and resources and whatever else we can throw in.
  * We will be announcing the winner of our Vista Ultimate giveaway on Show 26 next week.Â  If you haven't entered yet, now is the time!Â  It's really easy, just send feedback about the show to 
...
Quest LOVES PowerShell. Go to [www.quest.com / PowerShell][5] and download their free graphical user interface, script editor and Active Directory cmdlets. While you"™re there, join their online community where you can share ideas and download free PowerPacks to extend PowerGUI.Â  Visit [www.quest.com / powershell][5] today!  
We have Don Jones with us on the phone today.Â  Don Jones, for the three people who don't know who he is, has authored over thirty books.Â  He's a frequent speaker at conventions and also runs training classes for PowerShell.Â  Here are some notes we took during the conversation.
...
### Resources
  ...
  * Tobias from ScriptInternals has just started a PowerShell blog, you can find it on [PowerShellCommunity.org][7].Â  He intends to post often about how to use PowerShell Plus features.
...
### Tips
  ...
  * We found a nice script on the blog post [PowerShell and Excel][12] (from the "[Powershell,Passion,Persistence and Pursuit][13]" blog).Â  This script reads a server list from a text file and collects IP configuration settings of each server and uses that data to populate an excel sheet.
  ...
  * [Interesting article][16] that talks about working with Hyper-V virtual hard disks.Â  Some neat examples in there about passing text to console apps like diskpart.exe.
...
### Gotchas
  ...
  * The alias for Set-Content collides with sc.exe.Â  Workaround is to be sure to type sc-dot-exe.
  * There is no Remove-Alias cmdlet!Â  You can use the alias: PSProvider with "del" to get the job done.
...
### Give Away
  ...
  * As mentioned at the top of the show, we'll be announcing the winner of our Vista Ultimate giveaway next week.Â  If you want a chance at it, send us feedback about the show to powerscripting@gmail.com.

### Emails!

  * We got some GREAT feedback from a few listeners lately.Â  Some of whom were obviously motivated by the free copy of Vista, which is why we did it.Â  🙂
